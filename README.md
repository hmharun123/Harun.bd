...
header {
    ...
    .btn.darkgreen { background: #25D366; }
    .btn.purple { background: #8a3ab9; }
    .btn.pink { background: #FF69B4; }
    .btn.green { background: #1DBF73; }
    .icon { width: 20px; vertical-align: middle; margin-right: 5px; }
    .gallery img, .image-row img, .media-section img {
      max-width: 150px;
      margin: 10px;
      border-radius: 10px;
    }
...
<body>
  <div id="profile" class="section active">
    ...
    <a href="mailto:hmharun123@gmail.com?subject=Hiring Request&body=Hello, I would like to hire you for a project." target="_blank">
      <button class="button" style="background: crimson;">Order Now</button>
    </a>
  ...
  </div>  <div class="image-row section">
  ...
  </div>  <div class="gallery-section section">
    <h2>My Gallery</h2>
    <div class="gallery">
  ...
  </div>  <section id="youtube" class="section">
    <h2>My YouTube Channel</h2>
    <p>Subscribe to my channel for tutorials, tips, and more!</p>
    <a href="https://youtube.com/@mdharun-n6j" target="_blank">Visit My YouTube</a>
  </section>  <section id="portfolio" class="section portfolio-section">
    <h2>My Portfolio</h2>
    <ul>
